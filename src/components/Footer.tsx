        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-xl mb-xl">
          ...
          <div className="md:col-span-4 flex flex-col gap-md">
            ...
            <div className="flex items-center gap-md mt-xs">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/AuraMedicalMX" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-surface-variant/50 hover:text-primary-fixed transition-colors">
              ...
              {/* Instagram */}
              <a href="https://www.instagram.com/auramedical.mx" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-surface-variant/50 hover:text-primary-fixed transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              {/* YouTube */}
              <a href="https://www.youtube.com/@AuraMedicalMX" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-surface-variant/50 hover:text-primary-fixed transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              {/* LinkedIn */}
              <a href="https://www.linkedin.com/company/aura-medical-mx" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-surface-variant/50 hover:text-primary-fixed transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
