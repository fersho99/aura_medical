...
export default function NeurocirugiaMinimaInvasionPage() {
  return (
    <main>
        ...
        <nav aria-label="Breadcrumb">
          <ol className="flex items-center gap-xs type-label text-on-surface-variant flex-wrap">
            ...
            <li className="flex items-center gap-xs" aria-current="page">
              <span className="material-symbols-outlined text-sm">chevron_right</span>
              <span className="text-secondary font-medium">Neurocirugía de Mínima Invasión</span>
            </li>
          </ol>
        </nav>
      </div>
      ...
      <section className="relative w-full h-150 md:h-175 flex items-center justify-center overflow-hidden bg-slate-900">
        <div className="absolute inset-0 z-0">
          <img alt="Quirófano de neurocirugía con microscopio quirúrgico"
        ...
        <div className="relative z-10 max-w-7xl w-full mx-auto px-margin-mobile md:px-margin-desktop">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-sm px-md py-sm rounded-full glass-panel text-secondary-fixed type-label mb-md border border-secondary-fixed/30">
              ...
              Instituto de Neurociencias · Cirugía Avanzada
            </div>
        ...
        <div className="container-page">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-xl items-center">
            <div className="flex flex-col gap-md">
              ...
              <h2 className="type-display text-on-surface">¿En qué consiste?</h2>
              ...
              <div className="flex flex-col gap-sm mt-sm">
                {[
                  { icon: 'cut',        text: 'Incisiones mínimas — menor riesgo de infección y sangrado' },
                  { icon: 'hotel',      text: 'Estancia hospitalaria reducida: 2 a 5 días promedio' },
                  { icon: 'trending_down', text: 'Recuperación hasta un 50% más rápida que cirugía abierta' },
                ].map(({ icon, text }) => (
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl h-150 order-first lg:order-last">
              <img alt="Microscopio quirúrgico de neurocirugía"
              ...
              <div className="absolute bottom-md left-md right-md">
                <div className="inline-flex items-center gap-xs bg-surface/20 backdrop-blur-md rounded-full px-sm py-xs text-on-primary type-label">
                  ...
                  Quirófano Inteligente · Instituto de Neurociencias
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section bg-surface-container-low">
        <div className="container-page">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-md max-w-5xl mx-auto">
            {[
              { icon: 'oncology',        title: 'Tumores cerebrales',              desc: 'Gliomas, meningiomas y metástasis abordables mediante craneotomía microquirúrgica o endoscopia.' },
              { icon: 'compress',        title: 'Compresión medular o radicular',  desc: 'Hernias discales, estenosis espinal y tumores de columna que comprimen nervios o médula.' },
              { icon: 'water',           title: 'Hidrocefalia',                    desc: 'Colocación endoscópica de válvula de derivación o ventriculostomía endoscópica del tercer ventrículo.' },
              { icon: 'bolt',            title: 'Neuralgia del trigémino',         desc: 'Descompresión microvascular para alivio permanente del dolor facial severo.' },
              { icon: 'favorite_border', title: 'Malformaciones vasculares',       desc: 'Resección de cavernomas y malformaciones arteriovenosas (MAV) con neuronavegación.' },
              { icon: 'settings',        title: 'Estimulación Cerebral Profunda',  desc: 'Implante de electrodos para el tratamiento del Parkinson, temblor esencial y distonías.' },
            ].map(({ icon, title, desc }) => (
        ...
        <div className="container-page">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-xl items-center">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl h-150">
              <img alt="Quirófano con neuronavegación y microscopía de fluorescencia"
                className="absolute inset-0 w-full h-full object-cover"
            ...
            <div className="flex flex-col gap-md">
              ...
              <h2 className="type-display text-on-surface">Por qué elegirnos para su neurocirugía</h2>
              <p className="type-body-lg text-on-surface-variant">
              ...
              <div className="flex flex-col gap-md">
                {[
                  { icon: 'navigation',         color: 'text-secondary', bg: 'bg-secondary/10', title: 'Neuronavegación de Alta Precisión',        desc: 'Guía en tiempo real con fusión de imágenes de RMF, TC y tractografía para máxima seguridad.' },
                  { icon: 'light_mode',          color: 'text-primary',   bg: 'bg-primary/10',   title: 'Fluorescencia Intraoperatoria',            desc: 'Identificación precisa de tejido tumoral con 5-ALA y verde de indocianina para resección completa.' },
                  { icon: 'view_in_ar',          color: 'text-tertiary',  bg: 'bg-tertiary/10',  title: 'Mapeo Cortical Intraoperatorio',           desc: 'Estimulación eléctrica para identificar y preservar áreas de lenguaje y función motora durante la cirugía.' },
                  { icon: 'emergency',           color: 'text-error',     bg: 'bg-error/10',     title: 'UCI Neurológica Postoperatoria',           desc: 'Monitoreo neurológico intensivo las primeras 24-48 horas con EEG continuo y seguimiento de la PIC.' },
      ...
      <section className="section bg-slate-900 text-white overflow-hidden relative">
        ...
        <div className="container-page relative z-10 text-center flex flex-col items-center gap-md">
          <div className="w-16 h-16 rounded-full bg-secondary/20 border border-secondary-fixed/30 flex items-center justify-center">
            <span className="material-symbols-outlined text-secondary-fixed text-[32px]" style={{ fontVariationSettings: "'FILL' 1" }}>prescriptions</span>
          </div>
          <h2 className="type-display font-bold">¿Necesita una valoración neuroquirúrgica?</h2>
          <p className="type-body-lg text-slate-300 max-w-2xl">
            Nuestro equipo analiza cada caso de forma individual para determinar el abordaje más seguro y efectivo. Contáctenos para una primera consulta sin compromiso.
          </p>
