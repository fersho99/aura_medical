    ...
    <main>
        ...
        <nav aria-label="Breadcrumb">
          <ol className="flex items-center gap-xs type-label text-on-surface-variant flex-wrap">
            ...
            <li className="flex items-center gap-xs" aria-current="page">
              <span className="material-symbols-outlined text-sm">chevron_right</span>
              <span className="text-primary font-medium">Control de Niño Sano</span>
            </li>
          </ol>
        </nav>
      </div>
      ...
      <section className="relative w-full h-150 md:h-175 flex items-center justify-center overflow-hidden bg-slate-900">
        <div className="absolute inset-0 z-0">
          <img
            alt="Consulta de control de niño sano con pediatra especializado"
        ...
        <div className="relative z-10 max-w-7xl w-full mx-auto px-margin-mobile md:px-margin-desktop">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-sm px-md py-sm rounded-full glass-panel text-primary-fixed type-label mb-md border border-primary-fixed/30">
              ...
              Centro Pediátrico · Crecimiento y Desarrollo
            </div>
            ...
            <p className="type-body-lg text-slate-300 mb-lg">
              Seguimiento integral del crecimiento físico, cognitivo y socioemocional de su hijo en cada etapa del desarrollo, con los más altos estándares de medicina pediátrica preventiva.
            </p>
        ...
        <div className="container-page">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-xl items-center">
            ...
            <div className="flex flex-col gap-md">
              ...
              <h2 className="type-display text-on-surface">¿En qué consiste el Control de Niño Sano?</h2>
              <p className="type-body-lg text-on-surface-variant">
                El Control de Niño Sano es un programa de consultas preventivas periódicas en las que el pediatra evalúa el desarrollo físico, neurológico, emocional y social del niño, administra las vacunas correspondientes a su edad y orienta a los padres sobre crianza, nutrición y seguridad.
              </p>
              <p className="type-body text-on-surface-variant">
                En Aura Medical, estas consultas se realizan en ambientes diseñados para que el niño se sienta cómodo y seguro, con pediatras de dedicación exclusiva que dedican el tiempo necesario para atender tanto al paciente como a su familia.
              </p>
              <div className="flex flex-col gap-sm mt-sm">
                {[
                  { icon: 'calendar_month',  text: 'Frecuencia ajustada a la edad: mensual en el primer año de vida' },
                  { icon: 'monitoring',      text: 'Curvas de crecimiento comparadas con estándares internacionales OMS' },
                  { icon: 'family_restroom', text: 'Orientación personalizada para padres y cuidadores en cada visita' },
                ].map(({ icon, text }) => (
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl h-150 order-first lg:order-last">
              <img
                alt="Pediatra realizando control de niño sano en consultorio"
              ...
              <div className="absolute bottom-md left-md right-md">
                <div className="inline-flex items-center gap-xs bg-surface/20 backdrop-blur-md rounded-full px-sm py-xs text-white type-label">
                  ...
                  Consultorio Pediátrico · Aura Medical
                </div>
              </div>
            </div>
      ...
      <section className="section bg-surface-container-low">
        <div className="container-page">
          <div className="section-header">
            <h2 className="type-display text-on-surface mb-sm">Calendario de visitas recomendadas</h2>
            <p className="type-body text-on-surface-variant max-w-2xl mx-auto">
              La Organización Mundial de la Salud y la Academia Americana de Pediatría recomiendan visitas en momentos clave del desarrollo infantil.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-md max-w-5xl mx-auto">
            {[
              { icon: 'child_care',        title: 'Recién nacido (1-2 semanas)',   desc: 'Primera evaluación neonatal, peso, ictericia, alimentación y detección de anomalías congénitas.' },
              { icon: 'monitoring',        title: '2, 4 y 6 meses',               desc: 'Vacunación DPT, polio, Hib, hepatitis B y rotavirus. Evaluación del desarrollo motor y social.' },
              { icon: 'calendar_month',    title: '9 y 12 meses',                 desc: 'Introducción de sólidos, evaluación del gateo y la marcha. Vacuna MMR y varicela al año.' },
              { icon: 'school',            title: '15, 18 y 24 meses',            desc: 'Control del lenguaje, habilidades motoras finas y desarrollo social. Vacuna hepatitis A.' },
              { icon: 'face',              title: '3, 4 y 5 años',                desc: 'Preparación para la escuela: lectura visual, audición, vacunas de refuerzo y evaluación emocional.' },
              { icon: 'sports',            title: 'Escolar y adolescente (6–17)',  desc: 'Visitas anuales con énfasis en salud mental, nutrición, actividad física y vacunas de refuerzo.' },
            ].map(({ icon, title, desc }) => (
        ...
        <div className="container-page">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-xl items-center">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl h-150">
              <img
                alt="Área pediátrica amigable y colorida de Aura Medical"
                className="absolute inset-0 w-full h-full object-cover"
            ...
            <div className="flex flex-col gap-md">
              ...
              <h2 className="type-display text-on-surface">Por qué elegirnos para el cuidado de su hijo</h2>
              <p className="type-body-lg text-on-surface-variant">
                Nuestro Centro Pediátrico está diseñado pensando en el bienestar del niño y la tranquilidad de los padres en cada visita.
              </p>
              <div className="flex flex-col gap-md">
                {[
                  { icon: 'child_care',      color: 'text-primary',    bg: 'bg-primary/10',    title: 'Consultorio Pediátrico Exclusivo',          desc: 'Espacios diseñados para reducir la ansiedad infantil: colores, juguetes y ambientes amigables.' },
                  { icon: 'verified_user',   color: 'text-secondary',  bg: 'bg-secondary/10',  title: 'Pediatras con Subespecialidad',             desc: 'Neonatólogos, cardiólogos pediátricos y neurólogos pediátricos disponibles en el mismo centro.' },
                  { icon: 'vaccines',        color: 'text-tertiary',   bg: 'bg-tertiary/10',   title: 'Esquema de Vacunación Completo',            desc: 'Todas las vacunas del calendario nacional y opcionales en un solo lugar con registro digital.' },
                  { icon: 'emergency',       color: 'text-error',      bg: 'bg-error/10',      title: 'Urgencias Pediátricas 24 Horas',           desc: 'Área de urgencias pediátricas con médicos especializados disponibles en todo momento.' },
      ...
      <section className="section bg-slate-900 text-white overflow-hidden relative">
        ...
        <div className="container-page relative z-10 text-center flex flex-col items-center gap-md">
          <div className="w-16 h-16 rounded-full bg-primary/20 border border-primary-fixed/30 flex items-center justify-center">
            <span className="material-symbols-outlined text-primary-fixed text-[32px]" style={{ fontVariationSettings: "'FILL' 1" }}>child_care</span>
          </div>
          <h2 className="type-display font-bold">¿Desea agendar el control de su hijo?</h2>
          <p className="type-body-lg text-slate-300 max-w-2xl">
            Programar la primera visita es el mejor regalo que puede darle a su hijo. Nuestros pediatras están listos para recibirlos y brindarles el mejor cuidado.
          </p>
