/** Página: Contacto — Datos de contacto, mapa y formulario */

'use client'

import { useState } from 'react'
import { WA_URL, CLINIC_ADDRESS, CLINIC_EMAIL, CLINIC_PHONE } from '@/lib/constants'
...
const infoCards = [
  ...
  },
  {
    ...
    bg: 'bg-secondary/10',
    title: 'Teléfono',
    lines: [CLINIC_PHONE, 'Lun–Vie 8:00 – 20:00  |  Sáb 9:00 – 14:00'],
  },
  {
    icon: 'mail',
    color: 'text-tertiary',
    bg: 'bg-tertiary/10',
    title: 'Correo',
    lines: [CLINIC_EMAIL, 'Respuesta en menos de 24 horas hábiles'],
  },
  {
    icon: 'emergency',
    color: 'text-error',
    ...
    lines: ['911', 'Servicio de urgencias las 24 horas, los 365 días del año'],
  },
]
    ...
    <main>
      ...
      <section className="bg-surface-container-lowest border-b border-outline-variant/30 py-lg px-margin-mobile md:px-margin-desktop relative overflow-hidden">
        ...
        <div className="container-page relative z-10">
          ...
          <h1 className="type-display text-on-surface mb-sm">Contáctanos</h1>
          <p className="type-body-lg text-on-surface-variant max-w-2xl">
            Nuestro equipo de coordinación médica está disponible para resolver tus dudas, orientarte hacia el especialista correcto y agendar tu consulta.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-lg">
            ...
            <div className="md:col-span-2">
              ...
              <p className="type-body text-on-surface-variant mb-sm">
                Nos encontramos en <strong className="text-on-surface">{CLINIC_ADDRESS}</strong>, en San Luis Río Colorado, Sonora, a unos minutos del centro de la ciudad.
              </p>
